        ...
        <div className="w-full px-4 sm:px-6 h-20 md:h-24 flex items-center">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="hidden lg:flex gap-5 xl:gap-7 items-center text-sm font-medium text-gray-300">
              <Link href="/" className="hover:text-white transition-colors relative group whitespace-nowrap">
                Home
          ...
          >
            ...
            <div className="flex flex-col gap-2 relative z-10 px-4 pt-6 pb-8">
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.05 }}>
                <Link href="/" onClick={() => setIsOpen(false)} className="flex items-center justify-between py-4 px-4 text-xl font-bold text-white hover:text-primary transition-colors rounded-xl hover:bg-white/5 group">
                  Home
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }}>
                <button
                  ...
                  className="flex items-center justify-between w-full py-4 px-4 text-xl font-bold text-white hover:text-primary transition-colors rounded-xl hover:bg-white/5 group text-left"
                >
                  <span>Services</span>
                  <ChevronDown
                    size={20}
              ...
              <AnimatePresence initial={false}>
                {isMobileServicesOpen && (
                  ...
                  >
                    <div className="grid gap-2 rounded-2xl border border-white/10 bg-white/5 p-2 mb-2">
                      <Link
                        href="/services"
                        onClick={() => setIsOpen(false)}
                        className="rounded-xl px-3 py-2 text-sm font-semibold text-primary transition-colors hover:bg-white/5 hover:text-white flex items-center justify-between"
                      >
